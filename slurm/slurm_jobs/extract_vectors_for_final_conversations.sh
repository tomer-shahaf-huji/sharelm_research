...
#SBATCH --job-name=FinalConversationsVectorsExtraction
#SBATCH --partition=interactive   # Use a known available partition
#SBATCH --mem=60G                 # Use a safe amount of RAM
...
python -u slurm_jobs/extract_vectors_for_final_conversations.py
